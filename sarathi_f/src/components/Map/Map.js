          ...
          <div className="container-1">
            <div className="container-2">
              ...
              <div className="payment-btn-container">
                <button className="payment-btn-cancel payment-btn-confirm"   onClick={profile}  >Payment Confirmed</button>
    ...
    <>
      ...
      <div className="Apppp">
        ...
        <div className="map-input-container">
          ...
          <input className="map-input" type="text" placeholder="Origin" value={city_1} onChange={(e) => { setCity_1(e.target.value) }} />
          <input className="map-input" type="text" placeholder="Destination" value={city_2} onChange={(e) => { setCity_2(e.target.value) }} />
